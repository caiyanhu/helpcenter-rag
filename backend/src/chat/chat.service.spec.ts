...
type SearchResult = { id: string; score: number; content: string; articleId: number; articleTitle: string; categoryPath: string };
...
describe('ChatService.streamChat', () => {
  ...
  it('happy path: streams tokens and yields done with sources', async () => {
    const userMessage = 'This is a test message to check the streaming path in chat service implementation.';
    ...
    const milvusResults: SearchResult[] = [
      { id: 'r1', score: 0.9, content: 'c1', articleId: 101, articleTitle: 'A1', categoryPath: 'cat/1' },
      { id: 'r2', score: 0.88, content: 'c2', articleId: 102, articleTitle: 'A2', categoryPath: 'cat/2' },
      { id: 'r3', score: 0.85, content: 'c3', articleId: 103, articleTitle: 'A3', categoryPath: 'cat/3' },
    ];
